...
base_url = "http://localhost:5000"  # Update with your actual FastAPI server URL
...
# Make the POST request to the /demo/getStuff/ route
#response = requests.post(f"{base_url}/demo/getStuff/", json=data, headers=token)
